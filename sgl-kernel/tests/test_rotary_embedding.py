...
@pytest.mark.parametrize(
    ...
    [
        ...
        *[
        ...
        # Other cases
        (64, 64, 32, 8000, True, torch.bfloat16, get_device(), 32, 32, 1, 1, False),
        (
            256,
            128,
            4096,
        ...
        (512, 128, 311, 10000, True, torch.bfloat16, get_device(), 3, 39, 4, 2, False),
        (
            128,
            128,
            2048,
        ...
        (512, 128, 311, 10000, False, torch.bfloat16, get_device(), 3, 39, 4, 2, False),
        (64, 64, 32, 8000, True, torch.float32, get_device(), 32, 32, 1, 1, False),
        (256, 128, 4096, 10000, True, torch.float32, get_device(), 2, 512, 4, 2, False),
        (512, 128, 311, 10000, True, torch.float32, get_device(), 3, 39, 4, 2, False),
        (
            128,
            128,
            2048,
        ...
        (512, 128, 311, 10000, False, torch.float32, get_device(), 3, 39, 4, 2, False),
    ],
)
